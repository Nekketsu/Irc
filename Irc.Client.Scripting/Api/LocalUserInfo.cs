...
public class ChannelInfo : IChannelInfo
{
    ...
    internal static ChannelInfo FromChannel(Channel channel) => new(channel);
}
...
public class UserInfo : IUserInfo
{
    ...
    internal static UserInfo FromUser(User user) => new(user);

    internal static UserInfo FromNickname(Nickname nickname) => new(nickname.ToString());
}
